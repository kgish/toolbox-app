...
class ToolsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tool" do
    assert_difference('Tool.count') do
      post tools_url, params: { tool: { color: @tool.color, icon: @tool.icon, text: @tool.text, title: @tool.title } }
    end
  ...
  test "should update tool" do
    patch tool_url(@tool), params: { tool: { color: @tool.color, icon: @tool.icon, text: @tool.text, title: @tool.title } }
